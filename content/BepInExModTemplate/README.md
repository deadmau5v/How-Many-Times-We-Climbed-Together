...
![Climb stats screenshot](images/47abac2fde4a4f3770db9a203d9411a2.png)

## Features

- Tracks how many times you have climbed with each player across sessions.
- Shows a localized message when someone you have climbed with before joins the room.
- Adds a `Climb Stats` page to the PEAK pause menu.
...
Install with Thunderstore Mod Manager or Gale by searching for:

- `deadmau5v-HowManyTimesWeClimbedTogether`

The package will install its required dependencies automatically.
